...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ui->array_input->setPlaceholderText("Input");
    ui->SLL_input->setPlaceholderText("Input");
    ui->CLL_input->setPlaceholderText("Input");
    ui->DLL_input->setPlaceholderText("Input");
    ui->DCLL_input->setPlaceholderText("Input");
    ui->SQ_input->setPlaceholderText("Input");
    ui->CQ_input->setPlaceholderText("Input");
    ui->DQ_input->setPlaceholderText("Input");
    ui->stack_input->setPlaceholderText("Input");
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ui->array_input->setClearButtonEnabled(true);
    ui->SLL_input->setClearButtonEnabled(true);
    ui->CLL_input->setClearButtonEnabled(true);
    ui->DLL_input->setClearButtonEnabled(true);
    ui->DCLL_input->setClearButtonEnabled(true);
    ui->SQ_input->setClearButtonEnabled(true);
    ui->CQ_input->setClearButtonEnabled(true);
    ui->DQ_input->setClearButtonEnabled(true);
    ui->stack_input->setClearButtonEnabled(true);
}
...
void MainWindow::on_show_EXE_file_clicked()
{
    QString link="https://drive.google.com/drive/folders/16zWfjcNX8DL6u126AykizN7FZhFvsOkI?usp=sharing";
    QDesktopServices::openUrl(QUrl(link));
}
...
{
    QString link="https://drive.google.com/drive/folders/1yXkuKanjEHxqDohZClv6wI-lHNL9JU02?usp=sharing";
    QDesktopServices::openUrl(QUrl(link));
}
//////Array////
void MainWindow::on_array_insert_button_clicked(){
    ...
    QMessageBox::about(this,"Message",s);
